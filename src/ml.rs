...
impl Model {
    pub fn new() -> Model {
        ...
        let batch_size = 1;
        let model_file = include_bytes!("..\\model_building\\dominoes-torch_2021-05-29.onnx");
...
// pub fn predict<F, O>(runnable: Model, image: &DynamicImage) -> TractResult<(f32, i32)>
// where
